...
from .views import NationalityCreate, AboutCreate, HomelessCreate, AddictionCreate
from .views import NationalityUpdate, AboutUpdate, HomelessUpdate, AddictionUpdate
from .views import NationalityDelete, AboutDelete, HomelessDelete, AddictionDelete
from .views import NationalityList, AboutList, HomelessList, AddictionList
# AboutCreate
